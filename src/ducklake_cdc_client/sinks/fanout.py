...
from ducklake_cdc_client.sinks._inner import close_all, inner_name, open_all
from ducklake_cdc_client.sinks.base import BaseDDLSink, BaseDMLSink, DDLSink, DMLSink
